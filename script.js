...
const element5= document.getElementById('video-texto3');
const element6 = document.getElementById('img-text3');

const element7= document.getElementById('video-texto4');
